...
class StructuralElement(TimestampMixin, Base):
    ...
    section_name: Mapped[Optional[str]] = mapped_column(String(128))
    section_family: Mapped[Optional[str]] = mapped_column(String(128))
    ...
    inertia_x: Mapped[Optional[float]] = mapped_column(Float)
    inertia_y: Mapped[Optional[float]] = mapped_column(Float)
    section_modulus_x: Mapped[Optional[float]] = mapped_column(Float)
    section_modulus_y: Mapped[Optional[float]] = mapped_column(Float)
    torsion_constant: Mapped[Optional[float]] = mapped_column(Float)
    buckling_length_x: Mapped[Optional[float]] = mapped_column(Float)
    buckling_length_y: Mapped[Optional[float]] = mapped_column(Float)
    ...
    concrete_class_design: Mapped[Optional[str]] = mapped_column(String(128))
    concrete_class_actual: Mapped[Optional[str]] = mapped_column(String(128))
    rebar_class: Mapped[Optional[str]] = mapped_column(String(128))
    cover_thickness: Mapped[Optional[float]] = mapped_column(Float)
    reinforcement_ratio: Mapped[Optional[float]] = mapped_column(Float)
    rebar_area: Mapped[Optional[float]] = mapped_column(Float)
    carbonation_depth: Mapped[Optional[float]] = mapped_column(Float)
    chloride_exposure_class: Mapped[Optional[str]] = mapped_column(String(128))
    steel_grade_design: Mapped[Optional[str]] = mapped_column(String(128))
    steel_grade_actual: Mapped[Optional[str]] = mapped_column(String(128))
    weld_type: Mapped[Optional[str]] = mapped_column(String(128))
    bolt_class: Mapped[Optional[str]] = mapped_column(String(128))
    corrosion_loss_mm: Mapped[Optional[float]] = mapped_column(Float)
    ...
    material_density: Mapped[Optional[float]] = mapped_column(Float)
    support_type: Mapped[Optional[str]] = mapped_column(String(128))
    support_stiffness: Mapped[Optional[float]] = mapped_column(Float)
    support_kx: Mapped[Optional[float]] = mapped_column(Float)
    support_ky: Mapped[Optional[float]] = mapped_column(Float)
    support_kz: Mapped[Optional[float]] = mapped_column(Float)
    support_rx: Mapped[Optional[float]] = mapped_column(Float)
    support_ry: Mapped[Optional[float]] = mapped_column(Float)
    support_rz: Mapped[Optional[float]] = mapped_column(Float)
    joint_type: Mapped[Optional[str]] = mapped_column(String(128))
    joint_flexibility: Mapped[Optional[float]] = mapped_column(Float)
    joint_flexibility_x: Mapped[Optional[float]] = mapped_column(Float)
    joint_flexibility_y: Mapped[Optional[float]] = mapped_column(Float)
    joint_flexibility_z: Mapped[Optional[float]] = mapped_column(Float)
    source_type: Mapped[Optional[str]] = mapped_column(String(64))
...
class Defect(TimestampMixin, Base):
    ...
    damage_mechanism: Mapped[Optional[str]] = mapped_column(String(128))
    severity_class: Mapped[Optional[str]] = mapped_column(String(64))
    face_or_zone: Mapped[Optional[str]] = mapped_column(String(128))
    local_coordinate: Mapped[Optional[str]] = mapped_column(String(128))
    growth_rate_estimate: Mapped[Optional[float]] = mapped_column(Float)
    inspection_method: Mapped[Optional[str]] = mapped_column(String(128))
    confidence_severity: Mapped[Optional[float]] = mapped_column(Float)
...
class ObservationChannel(TimestampMixin, Base):
    ...
    axis_direction: Mapped[Optional[str]] = mapped_column(String(32))
    sign_convention: Mapped[Optional[str]] = mapped_column(String(64))
    load_case_reference: Mapped[Optional[str]] = mapped_column(String(128))
    temperature_compensated: Mapped[Optional[bool]] = mapped_column(Boolean)
    aggregation_method: Mapped[Optional[str]] = mapped_column(String(64))
    device_id: Mapped[Optional[str]] = mapped_column(String(128))
    calibration_reference: Mapped[Optional[str]] = mapped_column(String(255))
    source_type: Mapped[Optional[str]] = mapped_column(String(64))
