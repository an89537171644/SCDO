...
from apps.core import schemas, services


DEMO_PATH = Path(__file__).resolve().parents[1] / "sample_data" / "demo_bundle.json"


def load_demo_bundle(session: Session) -> str:
